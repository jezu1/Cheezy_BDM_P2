...
def create_reviews(spark , combined_df_reviews):
    #get the restaurants from datawarehouse table
    ...
    #append the new reviews to the review table
...
def create_opening_hours(spark, combined_df_opening_hours):
    ...
    spark.sql("""
        MERGE INTO delta.`hdfs://localhost:9000/user/hadoop/delta/warehouse/opening_hours` AS target
        USING opening_hours_tabel
...
def main():
    ...
    #append and update opening hours
